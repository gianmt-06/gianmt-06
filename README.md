...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="main.yml">
  <source media="(prefers-color-scheme: light)" srcset="main.yml">
  <img alt="github contribution grid snake animation" src="main.yml">
</picture>
